					...
					<CardHeader className="bg-white/5 border-b pt-6 border-white/10 pb-6 space-y-4">
						...
						<div className="flex flex-wrap gap-3">
							<div className="relative flex-1 min-w-60">
								...
								<Input
									placeholder="Название, инв. номер, модель…"
									value={search}
							...
							<Select value={typeFilter} onValueChange={setTypeFilter}>
								<SelectTrigger className="w-52 bg-background/50 border-white/10">
							...
							<Table>
								<TableHeader>
									<TableRow className="bg-white/5 hover:bg-white/5 border-white/10">
										<TableHead className="text-[10px] uppercase tracking-widest font-bold text-muted-foreground px-6 py-4">Оборудование</TableHead>
										<TableHead className="text-[10px] uppercase tracking-widest font-bold text-muted-foreground px-6 py-4">Идентификатор</TableHead>
												...
												>
													<TableCell className="px-6 py-4">
														<div className="flex items-center gap-3">
															<div className={`p-1.5 rounded-lg shrink-0 ${simple ? "bg-emerald-500/10" : "bg-primary/10"}`}>
																{simple
															...
															<div className="flex flex-col">
																...
																<span className="text-[10px] text-muted-foreground uppercase">{equipment.equipment_type}</span>
															</div>
														</div>
													</TableCell>
													<TableCell className="px-6 py-4 font-mono text-xs text-primary/80 group-hover:text-primary transition-colors">
														<div className="flex flex-col gap-0.5">
															...
															{!equipment.inventory_number && !equipment.serial_number && (
													...
													<TableCell className="px-6 py-4 text-right">
														<div className="flex justify-end gap-2">
															...
															<Button
																...
																title="Удалить"
																onClick={() => {
																	if (confirm(`Удалить ${displayLabel}?`)) {
