...
export default function StorageAndPassDetailPage() {
  ...
  const updateMutation = useMutation({
    mutationFn: (data: AssetFormData) => storageAndPassesApi.update(assetId, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['storage-and-pass', assetId] });
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(val) => setSelectedPersonnelId(parseInt(val))}
                      >
                        <SelectTrigger>
                  ...
                  <div className="text-sm">
                    ...
                    {asset.issue_date && (
                      <div className="mt-2 text-muted-foreground">
                        Выдано: {new Date(asset.issue_date).toLocaleString('ru-RU')}
                      </div>
                    )}
                  </div>
                </CardContent>
